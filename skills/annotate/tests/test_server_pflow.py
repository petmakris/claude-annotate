...
def test_the_title_comes_from_the_docstring():
    assert render_block(_blk())["spec"]["title"] == "How it goes."
...
def test_a_refused_source_yields_an_error_pill_naming_the_line():
    out = render_block(_blk(source=LOOPS))
