...
</div><span class="header-sep" aria-hidden="true"></span><span class="icon-btn-wrap">\
<button id="settings-toggle" type="button" class="icon-btn" aria-expanded="false" aria-controls="settings-pop" title="Settings — page width, code panes, theme, fonts" aria-label="Settings">\
...
</svg></button><div id="settings-pop" class="settings-pop" role="dialog" aria-label="Settings" hidden>\
...
<button id="highlighter-clear" type="button" class="icon-btn hl-clear" title="Clear every highlight on this page" aria-label="Clear highlights">\
...
</svg></button><span class="icon-btn-wrap">\
<button id="legend-toggle" type="button" class="icon-btn" aria-expanded="false" aria-controls="legend-pop" title="What do the buttons do?" aria-label="What do the buttons do?">\
<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9"/>\
<path d="M9.2 9.3a2.9 2.9 0 0 1 5.6 1c0 1.9-2.8 2.4-2.8 4"/><path d="M12 17.2h.01"/></svg></button>\
<div id="legend-pop" class="legend-pop" role="dialog" aria-label="What the buttons do" hidden>\
...
</div></div></span><span class="header-sep" aria-hidden="true"></span>\
<span class="read-only-badge" title="This link can read the document but not change it.">&#128065; Read-only</span>\
<button id="export-btn" type="button" class="export-btn" title="Save this document as a single standalone HTML file you can send to anyone">Share</button>\
